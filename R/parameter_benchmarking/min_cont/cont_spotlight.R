...
for(data_name in data_name_list){
  ...
  nmf = "nsNMF"; regr = "nnls";  regr_type = "nnls"
  ajust_path = paste(ajust_path, "/min_cont/", data_name,"/spotlight", sep = "")

  # change 1 and 1.1
  format = "min_cont=%s/"
  folder = sprintf(format, substr(paste(min_cont_list, collapse = "_"), 1 , 200))
