...

{
  ...
  decon_mtrx <- mixture_deconvolution_nmf1(nmf_mod = nmf_mod,
                                           ...
                                           min_cont = 0.01)
  saveRDS(decon_mtrx,"R/analyses/data/PDAC/decon_mtrx_ica_pdac_b.RDS")
